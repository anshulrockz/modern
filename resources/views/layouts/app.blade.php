    ...
    <body class="page-header-fixed page-sidebar-fixed">
        ...
        <div class="menu-wrap">
            <nav class="profile-menu">
                <div class="profile"><img src="{{asset('assets/images/profile-menu-image.png')}}" width="60" alt="Md Danish"/><span>Md Danish</span></div>
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="{{url('/')}}" class="logo-text"><span>Admin Panel</span></a>
                    </div><!-- Logo Box -->
                            ...
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-md dropdown-list theme-settings" role="menu">
                                        ...
                                        <li style="display: none" class="no-link"><button class="btn btn-default reset-options">Reset Options</button></li>
                                    </ul>
                                </li>
                            </ul>
                            <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <ul class="dropdown-menu title-caret dropdown-lg" role="menu">
                                        ...
                                        <li class="dropdown-menu-list slimscroll messages">
                                            <ul class="list-unstyled">
                                                <li>
                                                    <a href="#">
                                                        <div class="msg-img"><div class="online on"></div><img class="img-circle" src="{{asset('assets/images/avatar2.png')}}" alt=""></div>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="msg-img"><div class="online off"></div><img class="img-circle" src="{{asset('assets/images/avatar4.png')}}" alt=""></div>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="msg-img"><div class="online off"></div><img class="img-circle" src="{{asset('assets/images/avatar3.png')}}" alt=""></div>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="msg-img"><div class="online on"></div><img class="img-circle" src="{{asset('assets/images/avatar5.png')}}" alt=""></div>
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        ...
                                        <img class="img-circle avatar" src="{{ url('/uploads/'.Auth::id().md5(Auth::user()->name).'/'.Auth::user()->avatar) }}" width="40" height="40" alt="">
                                    </a>
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        <li role="presentation"><a href="{{url('profile')}}"><i class="fa fa-user"></i>Profile</a></li>
                                        <li role="presentation"><a href="{{url('change-password')}}"><i class="fa fa-key"></i>Change Password</a></li>
                                        <li role="presentation" class="divider"></li>
                                        <li role="presentation"><a href="{{url('lock-screen')}}"><i class="fa fa-lock"></i>Lock screen</a></li>
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                <div class="sidebar-profile-image">
                                    <img src="{{ url('/uploads/'.Auth::id().md5(Auth::user()->name).'/'.Auth::user()->avatar) }}" class="img-circle img-responsive" alt="Danish">
                                </div>
            ...
            <div class="page-inner">
                ...
                <div class="page-footer">
                    <p class="no-s">2017 &copy; Company, All Rights Reserved.</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
